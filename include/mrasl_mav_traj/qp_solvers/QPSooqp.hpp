 ...
 **/
#ifndef MRASL_MAV_TRAJ_QPSOOQP_HPP
#define MRASL_MAV_TRAJ_QPSOOQP_HPP

#include "QPPRoblem.hpp"

namespace mrasl {
    class QPSooqp : public QPProblem {
    public:
        QPSooqp(const MatrixXd H, const VectorXd c, const MatrixXd A,
                const VectorXd b);

        QPSooqp(const MatrixXd H, const MatrixXd A, const VectorXd b);
        ~QPSooqp(){};
...
#endif //MRASL_MAV_TRAJ_QPSOOQP_HPP
